				...
				<ul style="padding-left:0px;" class="list-group">
					...
					<li class="list-group-item">
						...
						<ul style="margin-top:10px;">
							...
							<li style="height:30px;">
								<a href="${basePath}/type/mytype" style="color:red;"><i class="glyphicon glyphicon-equalizer"></i> 分类管理</a> 
							</li>
							<li style="height:30px;">
          ...
          <div class="table-responsive">
            <table class="table  table-bordered">
              <thead>
                <tr >
                	<th>名称</th>
                	<c:forEach var="t" items="${list_type}">               		
                		<th>${t.tname}<input type="hidden" name="tid" value="${t.tid}"></th>               		
                	</c:forEach>                
                </tr>
              </thead>	
              						
              <tbody>                           
              		<c:forEach var="c" items="${list_cert}">
              			<script >             		
              				var str_a="${str_a}";
							console.log(str_a);              		              			              										
						</script>  						
                		  ...
                		  <c:forEach var="t" items="${list_type}">                 		  
                		  	<script>
                		  		if(str_a.indexOf('${c.cid}a${t.tid}')!=-1){
                		  			document.write("<td><input type='checkbox' name='id' value='${c.cid}a${t.tid}' checked  ></td>");
                		  		}else{
                		  			document.write("<td><input type='checkbox' name='id' value='${c.cid}a${t.tid}' ></td>");
                		  		}
                		  	</script>												
              ...
              <tr >
              	<td colspan="100" >            							
					...
					<button type="button" class="btn btn-primary" style="float:right;" onclick="adds()"><i class="glyphicon glyphicon-plus"></i> 保存</button>
					</form>	
					...
					<script type="text/javascript">
						function adds() {			
			                ...
			                console.log(ids);
			                if(ids==""){
			                	location="${basePath}/type/mymain";
			                }else{
			                	location="${basePath}/type/adu?ids="+ids;	
			                }
